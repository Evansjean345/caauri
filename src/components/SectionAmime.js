      ...
      <div className="w-full mt-6 flex flex-wrap bg-white relative">
        <div className="w-[60%]">
          ...
          <div className="flex flex-col py-4 px-6 sm:px-12">
            ...
            {/* nos services */}
            <strong className="w-full text-black mt-28 font-thin text-xl sm:text-2xl flex items-center justify-center">
              NOS SERVICES
            </strong>
          ...
          {/* div absolute */}
          <div className="absolute bg-black top-[67%] z-50 w-full items-center justify-center text-white  flex flex-col h-[300px]">
            <div>
        ...
        <div className="w-[38%] flex flex-col">
          ...
          <div className=" text-black mt-[1600px]">
