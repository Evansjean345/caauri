  ...
  return (
    <div>
      ...
      <div className={menu ? "bg-white text-black" : "blur-[7.5px] bg-white text-black"}>
          ...
          >
            <div className="items_div cursor-pointer  group h-[686px] w-[350px] transition-all  relative rounded-t-3xl overflow-hidden">
              <div className="flex flex-col justify-center rounded-t-3xl transition-all group-hover:bg-[#DFD4C0] pt-12 h-full items-center space-y-12">
                ...
                <img
                  src="https://s3-alpha-sig.figma.com/img/d269/2595/fa02e6cfab70f52d5dc4589677e2570b?Expires=1694390400&Signature=aqckVIVrKqdtu9lZisVci9kpwAoqWJmcyhXxodMQvZwovTsU7Z1pA~cYhwG6okIb-xkk2MvLo~96D1s3LftMpA5hr96wW9~m-e8UkywYsuKlgZ8Qt2PPmjnDisor8mQ~YplahiDvIoAq17nsN4dilPReiuwoKwDG2vxrhWw8IXjwoe7ZS-9xDj5zqQ9ZbeeXgjWpb7gFbyflVX7BKUy-L3jtX6CuCRY1TSpRlPFTrOgViz~lbTmP55QGIUjVQldHWS~NKPho3aCmDIDYl9VD3dpAxrYu9XVJgsGivl7biHRr1jtKKDCTK2UtJ-ul6c~PGyyaKhW31WoutnWKGrRo5w__&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4"
                  alt=""
        ...
        {/* Scroll section */}
        <div className="w-full flex flex-col mt-52 sm:px-12 px-2 xl:px-[104px]">
        ...
        <div className="w-full mt-32 h-[1037px] bg-black overflow-hidden flex-col flex items-center justify-center relative">
          ...
          <span className="text-white lg:text-8xl text-3xl z-20 sm:text-4xl font-medium mt-10 text-center">
            Un travail remarquable, et
            <br />
            rien de moins
          </span>
          <p className="text-center text-white text-xl z-20 sm:text-3xl lg:text-4xl font-thin mt-16">
          ...
          <span>
            <div className="mt-16 cursor-pointer z-20 flex w-[180px] gap-5 py-4 hover:gap-0   hover:flex hover:items-center hover:justify-center  hover:bg-white  transition-all px-2 text-white  hover:text-black hover:rounded-l-full hover:rounded-r-full">
